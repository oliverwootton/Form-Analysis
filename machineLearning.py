...
# Remove any missing or outlier data by dropping rows with NaN values and rows where the values of each column differ 
#from the mean of that column by more than 3 times its standard deviation.
